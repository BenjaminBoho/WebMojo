...
def trend_plot(prms):
    ...
    cluster_number=2 #クラスタ数　20200904変更＠野呂
    ...
    #外れ値のうち、Acc_diffが1以上の場合だけを異常検知とする
    df_Acc_outliers_plus=df_Acc_outliers.query("Acc_diff>1") #20200904修正＠野呂
    ...
    def lifetime(res_mv, mvlabel):
        ...
        if (eq_mv.coef[0] > 0):
            ...
            brainresult["output"]["lifetime1"][mvlabel] = int(jyum1_mv)
            brainresult["output"]["lifetime2"][mvlabel] = int(jyum2_mv)
