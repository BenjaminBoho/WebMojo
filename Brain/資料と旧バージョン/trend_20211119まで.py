...
def trend_plot(prms):
    ...
    plt.title("Moving Average {}".format(mv0),fontdict={'fontsize': 20})
    plt.tight_layout() 
    ...
    plt.title("lofscat",fontdict={'fontsize': 20})
    savefig(prms, "lofscat")    

    plt.figure()
    ax = plt.hist(np.array(LOFs)[np.isfinite(LOFs)], bins=100)
    plt.title("lofhist",fontdict={'fontsize': 20})
    ...
    plt.title("lofscat_out",fontdict={'fontsize': 20})
    ...
    plt.title("Moving Average {}".format(mv1),fontdict={'fontsize': 20})

    plt.subplot(3,1,2)
    plt.plot(df_mod["y"].rolling(mv2, min_periods=minpval).mean())
    plt.title("Moving Average {}".format(mv2),fontdict={'fontsize': 20})

    plt.subplot(3,1,3)
    plt.plot(df_mod["y"].rolling(mv3, min_periods=minpval).mean())
    plt.title("Moving Average {}".format(mv3),fontdict={'fontsize': 20})
    ...
    plt.hlines([limit1, limit2], 0, len(x), linestyle="dashed", color="r")
    plt.title("Comparison (Total range) ",fontdict={'fontsize': 20})
